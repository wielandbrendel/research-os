...
1. **Read Product Mission**: Load `research-os/project/mission.md` to understand:
...
2. **Read Product Roadmap**: Load `research-os/project/roadmap.md` to understand:
...
3. **Read Product Tech Stack**: Load `research-os/project/tech-stack.md` to understand:
